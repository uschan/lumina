...
import { 
  ...
  Plus, Trash2, Edit3, RefreshCw, X, LogOut, Check, Sparkles
} from 'lucide-react';
                            ...
                            <>
                                ...
                                <div className="border-t border-white/10 pt-4 mt-2">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <button onClick={handleAddFeature} className="w-full bg-white/10 py-1.5 rounded text-xs mt-2 hover:bg-white/20 transition-colors">+ Feature</button>
                                    </div>
                                </div>
