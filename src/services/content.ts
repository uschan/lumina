...
export const TOOLS: ToolItem[] = [
  { name: 'React 19', category: 'Frontend', description: 'Library', iconName: 'Atom' },
  { name: 'TypeScript', category: 'Language', description: 'Type safety', iconName: 'FileCode2' },
  { name: 'Tailwind CSS', category: 'Styling', description: 'Utility-first', iconName: 'Wind' },
  { name: 'Framer Motion', category: 'Animation', description: 'Physics based', iconName: 'Layers' },
  { name: 'Gemini 3 Pro', category: 'AI', description: 'Reasoning Model', iconName: 'Sparkles' },
  { name: 'Next.js 15', category: 'Framework', description: 'App Router', iconName: 'Box' },
  { name: 'Vite', category: 'Build', description: 'Lightning fast', iconName: 'Zap' },
  { name: 'Figma', category: 'Design', description: 'Prototyping', iconName: 'PenTool' },
];
...
export const ContentService = {
  ...
  getPostBySlug: (slug: string) => POSTS.find(p => p.slug === slug),
  getTools: () => TOOLS,
};