...
/**
 * ⚠️ DATA SOURCE WARNING ⚠️
 * 
 * The data below serves as FALLBACK / INITIAL STATE only.
 * The "True" database is located at `public/data.json`.
 * 
 * Decap CMS edits `public/data.json` directly. 
 * If you edit this file, it will NOT update the live content managed by the CMS.
 * 
 * ALWAYS 'git pull' before pushing to ensure you have the latest `data.json` from the CMS.
 */
