    ...
    try {
      ...
      for await (const chunk of stream) {
        ...
        setMessages(prev => {
           ...
           // Determine if we need to update the last message or add a new one (safety check)
           if (last.role === 'model') {
          ...
          >
            ...
            <div className="flex items-center justify-between p-4 border-b border-indigo-500/10 bg-indigo-500/5">
               <div className="flex items-center gap-2">
                 ...
                 <div className="flex flex-col">
                    ...
                    <span className="text-[10px] font-mono text-indigo-500 uppercase tracking-wider">Gemini 2.5 Active</span>
                 </div>
               </div>
               <button 
            ...
            <form onSubmit={handleSubmit} className="p-3 border-t border-indigo-500/10 bg-indigo-500/5 flex gap-2">
               <input
                 ...
                 placeholder="Ask about projects, stack, or bio..."
                 value={input}
